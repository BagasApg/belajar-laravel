...
@section('container')
        ...
        <div class="col-md-6">
            <form action="/posts" class="d-flex" role="search">
                ...
                <div class="input-group mb-3">
                    <input class="form-control me-2" type="search" placeholder="Dive the Blogs" name="search"
                ...
                @foreach ($posts as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            @else
                            <img src="https://source.unsplash.com/500x250?{{ $post->category->slug }}" class="card-img-top"
    ...
    @else
        <p class="text-center fs-4">Oh no, there is no post here :(</p>
    @endif
